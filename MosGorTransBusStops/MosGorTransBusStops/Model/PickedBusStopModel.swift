...
struct PickedWelcome: Codable {
    ...
    let shuttleType: JSONNull?
    let regional: Bool
    let debug: [JSONAny]

    enum CodingKeys: String, CodingKey {
        case id, name, type, wifi, bench, elevator, comment, hub, photo, commentTotalCount, routePath, color, routeNumber, isFavorite
        case shareURL = "shareUrl"
        case lat, lon, cityShuttle, electrobus, transportTypes, shuttleType, regional, debug
    }
}
...
struct RoutePath: Codable {
    let id: String?
    let routePathID, type, number: String
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case externalForecastTime, externalForecast, telemetryForecastTime, byTelemetryArray
        case routePathIDS = "routePathIds"
        case feature, sberShuttle, isFavorite, messages
    }
}
